...
const AnalyticsPage: NextPageWithLayout = () => {
  ...
  return (
    ...
    <Container maxWidth="xl">
      <Box width="100%">
        <Typography textAlign="center" sx={{fontFamily: "Roboto Mono", letterSpacing: "8px", fontSize: "120px", fontWeight: "700"}}>
          {title}
        </Typography>
        <Stack my={6} onSubmit={handleSubmit(onSubmit)} component="form">
          ...
          >
            <FormControl sx={{ display: "flex", flexDirection: "column", alignItems: "center"}}>
              <FormLabel id="typeData" sx={{ marginTop: "15px", marginBottom: "15px"}}>Tipo de datos</FormLabel>
              <RadioGroup
          ...
          <LoadingButton
            ...
            variant="contained"
            loading={loading}
            sx={{ width: "400px", background: "#263366", alignSelf: "center"}}
          >
            Ejecutar {title}
          </LoadingButton>
        </Stack>
